...
export default class Link {
    ...
    getControl = (): string => {
        // prettier-ignore
        return [
            `<div class='${this.name}' id='_lithosphere_control_link_root' title='Link' style='width: 26px; height: 26px; color: ${this.return.isLinked ? 'black' : 'white'}; background: ${this.return.isLinked ? '#ffdd5c' : '#1d1f20'}; font-size: 24px; line-height: 27px; text-align: center; cursor: pointer;'>`,
        ...
        document
            ...
            .addEventListener('click', () => {
                ...
                if (this.return.isLinked) {
                    linkRoot.style.background = '#ffdd5c'
                    linkRoot.style.color = 'black'
                } else {
                    linkRoot.style.background = '#1d1f20'
