...
export default class Link {
    ...
    getControl = (): string => {
        // prettier-ignore
        return [
            `<div class='${this.name}' id='_lithosphere_control_link_root' title='Link' style='width: 26px; height: 26px; color: ${this.return.isLinked ? 'black' : 'white'}; background: ${this.return.isLinked ? '#ffdd5c' : 'black'}; font-size: 24px; line-height: 27px; text-align: center; cursor: pointer;'>`,
