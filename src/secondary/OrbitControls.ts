 ...
 * @author tsoliman https://github.com/tariqksoliman
 */
...
export default function OrbitControls(object, domElement) {
    ...
    //Make pan up the unused pan axis
    this.flipPanUp = false //MMWebGISChange==================
    ...
    function getDomElement() {
        return scope.domElement === document
    ...
    var panLeft = (function () {
        ...
        return function panLeft(distance, objectMatrix) {
            ...
            var te = objectMatrix.elements //MMWebGISChange================
            if (scope.flipPanUp)
                //MMWebGISChange================
                v.set(te[0], 0, te[2]).normalize()
            else v.set(te[0], te[1], 0).normalize()
    ...
    var panUp = (function () {
        ...
        return function panUp(distance, objectMatrix) {
            ...
            if (scope.flipPanUp)
                //MMWebGISChange================
                v.set(te[4], 0, te[6]).normalize()
            else v.set(te[4], te[5], 0).normalize()
    ...
    function handleMouseMoveDolly(event) {
        ...
        var element = getDomElement()
        var speedMultiplier =
            Math.abs(dollyDelta.y) / (0.01 * element.clientHeight)
    ...
    function handleTouchStartDollyPan(event) {
        ...
        if (scope.enablePan === true) {
            ...
            var centerX =
                (event.touches[0].pageX + event.touches[1].pageX) / 2.0
            var centerY =
                (event.touches[0].pageY + event.touches[1].pageY) / 2.0
    ...
    function onMouseWheel(event) {
        ...
        event.preventDefault()
        //event.stopPropagation(); //MMWebGISChange================
        ...
        switch (event.touches.length) {
            ...
            case 2: // two-fingered touch: dolly or dolly + pan
                ...
                if (scope.enableTwoFingerZoomPan === true) {
                    ...
                    state =
                        scope.enableZoom === true && scope.enablePan === true
                            ? STATE.TOUCH_DOLLY_PAN
                            : scope.enableZoom === true &&
                              scope.eanblePan === false
                            ? STATE.TOUCH_DOLLY
                            : STATE.TOUCH_PAN
                } else {
                    if (scope.enableZoom === false) return
